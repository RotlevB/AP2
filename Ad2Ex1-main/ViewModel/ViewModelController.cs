...
namespace ad2ex1.ViewModel
{
...

        {
            ...
            set
            {
                if(VM_CurrentLineNumber != value)
                {
                    VM_CurrentLineNumber = value;
        ...
        public List<string> VM_PropertiesNames
        {
            get
            {
        ...
        public float VM_Attitude
        {
            get
            {
                return clientModel.Attitude;
            }
        }

        public float VM_Flight_direction
        {
            get
            {
                return clientModel.Flight_direction;
            }
        }
        ...
        public List<List<string>> VM_allPropertiesLists
        {
            get
            {
                return clientModel.allPropertiesLists;
